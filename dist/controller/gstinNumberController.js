...
exports.getGSTINData = void 0;
const joiValidation_1 = require("../utils/joiValidation");
const axios_1 = __importDefault(require("axios"));
const getGSTINData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e, _f;
    try {
        const { error, value } = joiValidation_1.gstinValidation.validate(req.body);
        if (error) {
            res.status(400).json({ success: false, message: error.details[0].message });
            return;
        }
        const gstinNumberUpperCase = (_a = value.gstinNumber) === null || _a === void 0 ? void 0 : _a.toUpperCase().trim();
...
exports.getGSTINData = getGSTINData;
